...
<Tabs>
  ...
  <picture>
  <source media="(prefers-color-scheme: dark)" srcset="../public/foundations/getstarted/foundations-getstarted-intro@dark.png 4x">

  <img decoding="async" loading="lazy" alt="A sketch of the Accessibility icon. The image is tinted in shades of green." srcset="../public/foundations/getstarted/foundations-getstarted-intro.png 4x" src="../public/foundations/getstarted/foundations-getstarted-intro.png" width="100%" height="auto">
  </picture>
