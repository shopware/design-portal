<template>
    <div class="HowToIntegrateInter">
      ...
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="../../public/foundations/getstarted/foundations-getstarted-inter--download@dark.png 4x">

        <img decoding="async" loading="lazy" alt="A sketch of the Accessibility icon. The image is tinted in shades of green." srcset="../../public/foundations/getstarted/foundations-getstarted-inter--download.png 4x" src="../../public/foundations/getstarted/foundations-getstarted-inter--download.png" width="100%" height="auto">
      </picture>
